...
uses
	...
	EngineResourceLoader, EngineStrings, EngineShape;
...
function ColModelLoader(const cache: Pointer; const cachesize: cardinal;
...
function IndexedColModelLoader(const cache: Pointer; const cachesize: cardinal;
	out conttype: TGameResourceType): TObject;
var
	bytesize: longword;
...
initialization
	...
	SetLoader(grbIndexedColModel, @IndexedColModelLoader);
end.
